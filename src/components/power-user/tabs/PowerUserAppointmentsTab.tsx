...
import { Calendar, Plus, Users, Clock, TrendingUp, CheckCircle, Search, Filter } from 'lucide-react';
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {appointment.status === 'checked_in' && (
                            <Button 
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                handleStartService(appointment.id);
                              }}
                          ...
                          {appointment.status === 'in_progress' && (
                            <Button 
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                handleCompleteService(appointment.id);
                              }}
