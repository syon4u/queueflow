...
const BrowardHeader: React.FC<BrowardHeaderProps> = ({
  ...
  return <header className="bg-white border-b border-neutral-200 shadow-sm dark:bg-neutral-100 dark:border-neutral-200">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              {user ? <div className="text-sm">
                ...
                </div> : <Link to="/login" className="btn btn-primary">
                  Sign In
                </Link>}
            </div>
          </div>
