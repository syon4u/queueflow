...
import { Customer } from '../CustomerSearchBox';
...
export type ExistingCustomerFormValues = z.infer<typeof existingCustomerFormSchema>;
...
interface ExistingCustomerFormProps {
  ...
  onSubmit: (data: ExistingCustomerFormValues) => void;
  onBack: () => void;
