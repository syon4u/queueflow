...
const EnhancedAppointmentTable: React.FC = () => {
  ...
  return <TooltipProvider>
      <div className="space-y-8 p-6 bg-gray-50 min-h-screen">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Button onClick={() => setShowFilters(!showFilters)} variant="outline" size="sm" className="bg-white">
        ...
        }].map(status => <Card key={status.label} className={`${status.bgColor} ${status.borderColor} border-2 hover:shadow-md transition-shadow`}>
        ...
        {/* Filters Section */}
        {showFilters && <div className="animate-fade-in">
        ...
        <Card className="shadow-sm border-0 bg-white rounded-xl overflow-hidden">
          ...
          <CardContent className="p-0">
            {isLoading ? <div className="flex flex-col items-center justify-center p-12">
              ...
              </div> : filteredAppointments.length === 0 ? <div className="text-center p-12 bg-gray-50">
                <div className="max-w-md mx-auto">
                  ...
                  <p className="text-gray-500 mb-6">
                    {appointments.length > 0 ? "Try adjusting your filters to see more results" : "Create your first appointment to get started"}
                  </p>
                ...
                <Table>
                  ...
                  <TableBody>
                    {filteredAppointments.map((appointment, index) => <AppointmentTableRow key={appointment.id} appointment={appointment} onAction={handleAction} />)}
                  </TableBody>
                </Table>
              </div>}
          </CardContent>
        ...
        <SendReminderDialog open={reminderDialogOpen} onOpenChange={setReminderDialogOpen} appointment={selectedAppointment} />
