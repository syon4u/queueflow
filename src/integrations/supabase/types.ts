    ...
    Tables: {
      ...
      customer_location_services: {
        Row: {
          ...
          is_custom_service: boolean | null
        ...
        Relationships: [
          {
            foreignKeyName: "customer_location_services_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "customers"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "customer_location_services_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "customer_location_services_service_id_fkey"
            columns: ["service_id"]
            isOneToOne: false
            referencedRelation: "services"
            referencedColumns: ["id"]
